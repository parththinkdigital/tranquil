<nav class="fixed top-6 left-6 right-6 z-50">
    <div
        class="max-w-7xl mx-auto px-6 py-4 bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-teal-50 flex justify-between items-center">
        ...
        <div class="hidden md:flex gap-8 items-center font-medium">
            ...
            <a href="{{ route('properties.index', ['type' => 'rent']) }}"
                class="hover:text-primary transition-colors">Rent</a>
